    ...
    <div class="container1">
          <article class="box" id="home_featured21">
            <div class=" block"   align="left">
                 ...
                 <a height="750px" width="300px" class="twitter-timeline" href="https://twitter.com/Juaniitta_Q" data-widget-id="516609494206279680">Tweets por @Juaniitta_Q</a>
                 <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
            </div>
            <div  align="left">
                <table width="340px" height="100px" border="2px" bgcolor="white"  style="margin-left: 490px;">
<tr>
<td style='overflow : auto; border-radius: 20px;'>
 <h2 align="center">Noticias <br/><br/>
				  <img width="300px" height="100px" style="border-radius: 20px; align:center; " src="images/slider3.jpg" /><br/>
				 </h2>
				 <?php
        //codigo para mandar a traer todas las noticias que estan almacenados en la base de datos.	

//consulta		
$consulta = mysql_query("SELECT *FROM noticias order by id_not desc");
while ($row= mysql_fetch_array($consulta)){

			echo "<p align='center'>";
			echo "<a style='align:center;' href='1noticia.php?id_not=".$row['id_not']."'>" . $row['titulo'] . "<br/></a></p>";
}
